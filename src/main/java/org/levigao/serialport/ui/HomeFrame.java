...
public class HomeFrame extends JFrame {
    ...
    private void initComponents() {
        ...
        mDatePicker.setBounds(5+UIConfig.CHINESE_CHARACTER_WIDTH*5,25,
        ...
        mMotorLabel.setBounds(5, 30+UIConfig.CHINESE_CHARACTER_WIDTH*3,
                UIConfig.CHINESE_CHARACTER_WIDTH*4,
                UIConfig.CHINESE_CHARACTER_WIDTH);
        mMotorLabel.setFont(UIConfig.TEXT_FONT);
        mMotorLabel.setBackground(Color.RED);
       ...
       //第三行第一个组件
        ...
        mReductionRateLabel.setBounds(5, 30+UIConfig.CHINESE_CHARACTER_WIDTH*6,
                UIConfig.CHINESE_CHARACTER_WIDTH*4,
                UIConfig.CHINESE_CHARACTER_WIDTH);
        mReductionRateLabel.setFont(UIConfig.TEXT_FONT);
        mReductionRateLabel.setBackground(Color.RED);
        mReductionRateLabel.setOpaque(true);
        mHomePanel.add(mReductionRateLabel);


        mReductionRateTextArea.setBounds(5+UIConfig.CHINESE_CHARACTER_WIDTH*5,
